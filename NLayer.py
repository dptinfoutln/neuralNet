...
class NLayer:
    def __init__(self,data,config,activation,seuilIter,stepGenerator,nbEx):
        self.data = data
    ...
    def __next__(self):
        ...
        if self.squaredError < self.seuil or self.nbIterations > self.iter:
                raise StopIteration
        self.retroprop()
        self.nbIterations+=1
